    ...
    document.addEventListener("alpine:init", () => {
        ...
        let categories_dropdown = {
            ...
            style: {
                ...
                select: "border w-full border-slate-300 rounded-lg py-2 px-2 text-sm flex gap-2 items-center cursor-pointer bg-white dark:bg-slate-700",
                menuWrapper: "w-full rounded-lg py-1.5 text-sm mt-1 shadow-lg absolute bg-white z-10 dark:bg-slate-700",
                menu: "max-h-52 overflow-y-auto",
                textList: "overflow-x-hidden text-ellipsis grow whitespace-nowrap dark:text-slate-100",
                trigger: "px-2 py-2 rounded bg-slate-100 text-slate-300 dark:bg-slate-800",
                badge: "py-1 px-3 rounded-full bg-slate-100 dark:bg-slate-800 dark:text-slate-100",
                search: "px-3 py-2 w-full border-0 border-b-2 border-slate-100 dark:border-slate-800 dark:bg-slate-700 dark:text-slate-100 pb-3 outline-0 mb-1",
                optionGroupTitle: "px-3 py-2 text-slate-300 uppercase font-bold text-sm sticky top-0 bg-white dark:bg-slate-600 dark:text-slate-100",
                clearSearchBtn: "absolute p-3 right-0 top-1 hidden",
                label: "hover:bg-slate-50 dark:hover:bg-slate-800 cursor-pointer flex py-2 px-3 dark:text-white"
            },
            ...
            init() {
                ...
                wrapper.setAttribute("x-data", "newCategoriesSelect");

                const newCategoriesSelect = document.createElement("div");

                newCategoriesSelect.className = style.select;
                newCategoriesSelect.setAttribute("x-bind", "selectTrigger");
                ...
                newCategoriesSelect.append(textList);
                newCategoriesSelect.append(countBadge);
                newCategoriesSelect.append(triggerBtn);
                ...
                wrapper.appendChild(newCategoriesSelect);
                wrapper.appendChild(menuWrapper);

                Alpine.data("newCategoriesSelect", () => ({
                    ...
                    regenerateTextItems() {
                        ...
                        if (this.selectedItems.length === 0) {
                            ...
                            textList.innerHTML = '<span class="text-slate-300">Choose Categories</span>';
                    ...
                    checkBox: {
                        ...
                        ["@change"]() {
                            ...
                            if (checkBox.checked) {
                                ...
                                originalSelect.querySelector("option[value='" + checkBox.value + "']").setAttribute("selected", true);

                            } else {

                                originalSelect.querySelector("option[value='" + checkBox.value + "']").removeAttribute("selected");
                    ...
                    listItem: {
                        ...
                        ["x-show"]() {
                            return (
                                this.filterBy === "" ||
                                this.$el.innerText.toLowerCase().startsWith(this.filterBy.toLowerCase()));
                    ...
                    groupTitle: {
                        ...
                        ["x-show"]() {
                            ...
                            this.$el.nextElementSibling.querySelectorAll("li").forEach(item => {
                                ...
                                if (
                                    item.innerText.toLowerCase().startsWith(this.filterBy.toLowerCase()))
        ...
        let tags_dropdown = {
            ...
            init() {
                ...
                wrapper.className = style.wrapper;
                wrapper.setAttribute("x-data", "newTagsSelect");

                const newTagsSelect = document.createElement("div");

                newTagsSelect.className = style.select;
                newTagsSelect.setAttribute("x-bind", "selectTrigger");
                ...
                newTagsSelect.append(textList);
                newTagsSelect.append(countBadge);
                newTagsSelect.append(triggerBtn);
                ...
                wrapper.appendChild(newTagsSelect);
                wrapper.appendChild(menuWrapper);

                Alpine.data("newTagsSelect", () => ({
                    ...
                    regenerateTextItems() {
                        ...
                        if (this.selectedItems.length === 0) {
                            ...
                            textList.innerHTML = '<span class="text-slate-300">Choose tags</span>';
        ...
        Alpine.data("categories", () => (categories_dropdown));
        Alpine.data("tags", () => (tags_dropdown));
