<x-filament-breezy::grid-section md=2 :title="__('filament-breezy::default.profile.sanctum.title')"
    ...
    @if($plainTextToken)
        <div class="space-y-2 bg-warning-500">
            ...
            <input type="text" disabled
                   @class(['w-full py-1 px-3 rounded-lg bg-slate-100 border-slate-200 dark:bg-slate-700 dark:border-slate-500']) name="plain_text_token"
            ...
            <div class="flex items-center justify-between">
                ...
                <x-filament::button icon="heroicon-s-clipboard-document-check" size="sm" type="button"
                                    wire:click="$set('plainTextToken',null)">{{ __('filament-breezy::default.profile.sanctum.copied.label') }}
                </x-filament::button>
            </div>
